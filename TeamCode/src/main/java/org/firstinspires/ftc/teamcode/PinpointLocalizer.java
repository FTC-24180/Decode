...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        ...
        public double perpXTicks = -6.5; //6.624; // x position of the perpendicular encoder (in tick units)
    }
    ...
    private Pose2d txPinpointRobot = new Pose2d(0, 0, 0);//x=0 y=-4.7244 h=0
