...
public class PoseStorage {
        ...
        public static Pose2d currentPose = new Pose2d(0,0,Math.toRadians(0)); //This is a default pose to use for manual testing. It must be set by autonomous to use auto functions in teleop
